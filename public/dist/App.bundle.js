...
function ajaxHeart(e) {
    ...
    _axios2.default.post(this.action).then(function (res) {
        ...
        if (isHearted) {
            ...
            setTimeout(function () {
                return _this.heartclassList.remove('heart__button--float');
            }, 2500);
        }
    });
}
...
function typeAhead(search) {
    ...
    //handle keyboard inputs up, down, enter
    searchInput.on('keyup', function (e) {
        //if they aren't pressing up, down or enter exit
        ...
        var next = void 0;
        if (e.keyCode === 40) {
            current ? next = current.nextElementSibling || items[0] : next = items[0];
        } else if (e.keyCode === 38) {
            current ? next = current.previousElementSibling || items[items.length - 1] : next = items[items.length - 1];
